	...
	*/
	...
	<a href="<?php echo H_ADMIN;?>&view=orange_credit_farm_appraisal&id=<?php echo $rows->id;?>&do=details" title="View Details" class="btn btn-default btn-sm tip"><i class="fa fa-th-list"></i> <?php echo LANG_DETAILS;?></a>
	
	<a href="<?php echo H_ADMIN;?>&view=orange_credit_farm_appraisal&id=<?php echo $rows->id;?>&do=delete&dfile=" title="<?php echo LANG_TIP_DELETE;?>" class="btn btn-default btn-sm tip" data-confirm="<?php echo LANG_DELETE_AUTH;?>"><i class="fa fa-trash-o"></i> <?php echo LANG_DELETE;?></a>
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE;?> Orange Credit Farm Appraisal</h3></div>
  <div class="panel-body pformmargin">
	...
	<input id="farm_name" name="farm_name" type="text" maxlength="100"  value="<?php echo $rows->farm_name;?>" class="form-control styler" />
	</div>

	<div class="form-group">
    <label class="control-label" for="farm_address">Farm Address</label>
	<input id="farm_address" name="farm_address" type="text" maxlength="255"  value="<?php echo $rows->farm_address;?>" class="form-control styler" />
	</div>
	...
	<option value="<?php echo $rows->farm_management_style;?>"><?php echo $rows->farm_management_style;?></option><option value="SELF MANAGEMENT">SELF MANAGEMENT</option>
	...
	<input id="farm_produce_type" name="farm_produce_type" type="text" maxlength="100"  value="<?php echo $rows->farm_produce_type;?>" class="form-control styler" />
	</div>

	<div class="form-group">
    <label class="control-label" for="farm_size_total">Farm Size Total</label>
	<input id="farm_size_total" name="farm_size_total" type="text" maxlength="100"  value="<?php echo $rows->farm_size_total;?>" class="form-control styler" />
	</div>
	...
	<option value="<?php echo $rows->farm_revenue_cycle;?>"><?php echo $rows->farm_revenue_cycle;?></option><option value="ALL YEAR CYCLE">ALL YEAR CYCLE</option>
	...
	<option value="<?php echo $rows->farm_revenue;?>"><?php echo $rows->farm_revenue;?></option><option value="BETWEEN_N50K_TO_250K">BETWEEN_N50K_TO_250K</option>
	...
	<option value="<?php echo $rows->farm_profit_margin;?>"><?php echo $rows->farm_profit_margin;?></option><option value="BELOW 10%">BELOW 10%</option>
	...
	<input name="farm_date_created" class="datepicker form-control styler" type="text" maxlength="100" value="<?php echo $rows->farm_date_created;?>" />
	</div>

	<div class="form-group">
    <label class="control-label" for="farm_date_mordified">Farm Date Mordified</label>
	<input name="farm_date_mordified" class="datepicker form-control styler" type="text" maxlength="100" value="<?php echo $rows->farm_date_mordified;?>" />
	</div>
