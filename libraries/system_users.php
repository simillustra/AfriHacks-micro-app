...
class admin_users_model
{
    ...
    public function successful_registration_notice($params)
    {
        ...
        $sms_message = "ASFA LLC SUPPORT\r\n";
        $sms_message .= "Dear " . $captionInput->fullname . " congratulations, your wallet have been activated with ASFA LTD.\r\n";
        $sms_message .= "Acc No:" . $captionInput->account . "\r\n";
        $sms_message .= "Pw: " . $captionInput->password . "\r\n";
        $sms_message .= "Start Saving today\r\n";


        $email_message = "Dear " . $captionInput->fullname . " congratulations, your wallet have been activated with ASFA LTD.\r\n";
    ...
    {
        $captionInput = json_decode($params);
        $sms_message = "ASFA LTD SUPPORT\r\n";
        $sms_message .= "Hi " . $captionInput->fullname . " Welcome to ASFA LTD.\r\n";
        ...
        $email_message = "Hi " . $captionInput->fullname . " Welcome to ASFA LTD.\r\n";
    ...
    public function HezeLogin($params, $password, $table)
    {
        ...
        try {
            ...
            $hash = user_password_encrypt($password);
            if ($hash == user_password_encrypt($password, $my_password)) {
...
//            $hash = hezecom_crypt($password);
            if (user_password_encrypt($password, $my_password)) {
                // TODO : add query of permission based on $data['membership']
