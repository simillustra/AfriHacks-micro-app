...
$DATABASE_SERVER = APP_MODE == 'DEV' ? 'localhost' : "database-1.c25mdhmpiy39.us-east-1.rds.amazonaws.com";
$DATABASE_USERNAME = APP_MODE == 'DEV' ? 'root' : "asfaAdmin2022";
$DATABASE_PASSWORD = APP_MODE == 'DEV' ? '' : "S!m14526%&%";
$DATABASE_NAME = APP_MODE == 'DEV' ? 'asfa' : "asfaDatabaseServer";
$DATABASE_PORT = 3306;
...
define('H_ADMIN_ACCOUNT_NAME', 'ASFA LLC');
