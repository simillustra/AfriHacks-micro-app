...
//orange_credit_farm_appraisal
if (get('view') == 'orange_credit_farm_appraisal') {
    include (APP_FOLDER . '/controllers/admin/orange_credit_farm_appraisal.php');
    $_controller = new orange_credit_farm_appraisal_controller();
    $_controller->invoke_orange_credit_farm_appraisal();
}
