...
class orange_credit_notifications_model
{
    ...
    public function successful_registration_notice($params)
    {
        ...
        $sms_message = "ASFA SUPPORT\r\n";
        $sms_message .= "Congratulations, your wallet have been activated with ASFA.";
        $sms_message .= "Acc No:";
        $sms_message .= "Pw:";
    ...
    public function user_kyc_approved($params)
    {
        ...
        $sms_message .= "You are now eligible to apply and access ASFA loans.\r\n";
        $sms_message .= "Login now and start saving";

        $email_message = "Hi ".$captionInput->fullname." Your KYC has being approved\r\n";
        $email_message .= "You are now eligible to apply and access ASFA loans.\r\n";
    ...
    public function user_kyc_declined($params)
    {
        ...
        $sms_message .= "Please review again to be eligible to apply and access ASFA loans.\r\n";
        $sms_message .= "Login now and review, thanks";

        $email_message = "Hi ".$captionInput->fullname." Your KYC form entry has being declined.\r\n";
        $email_message .= "Please review again to be eligible to apply and access ASFA loans.\r\n";
