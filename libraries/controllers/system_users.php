        ...
        if ($haccess->UserAccess()->user_position == 1) {
            if (post('button')) {
                ...
                if (post('first_name') == '') {
                    ...
                    json_error('Your phone number should be 13 characters long and in this format 2348000000000');
                    ...
                    $password = user_password_encrypt(trim(post('password')));
    ...
    elseif (get('do') == 'updatepwd') {
        ...
        if (post('button')) {
            ...
            if (post('password') == '') {
                ...
                $password = user_password_encrypt(post('password'));
